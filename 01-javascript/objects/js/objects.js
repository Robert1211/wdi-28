...
const library = [
  {title: 'Everything and More', author: 'David Foster Wallace', alreadyRead: true},
  {title: 'Bleak House', author: 'Charles Dickens', alreadyRead: false},
...
const movieInfo = function (m) {
  const blurb = `${ m.title } lasts for ${ m.duration } minutes. Stars: ${ m.stars.join(', ') }`;
  console.log( blurb );
  return blurb;
};
