...
const moreThan3Characters = function (word) {
  return word.length > 3;
};
const enoughCharacters = _(words).every(moreThan3Characters);
console.log( enoughCharacters );

// - Check if some words are over twenty characters long
const moreThan20Characters = function (word) {
  return word.length > 20;
}
const longWords = _(words).some(moreThan20Characters);
